...
$insert_product ="insert into product(product_name,category_name,product_image,product_price, product_location,product_country,product_description,user_email)values ('$product_name','$product_category','$name','$product_price','$product_location','$product_country','$product_description','$emails')";

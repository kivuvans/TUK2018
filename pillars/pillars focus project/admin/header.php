...
<ul class="nav navbar-nav navbar-right">
	...
	echo "<li><a href='dashboard.php'><span class=' fa fa-user' style='color:palegreen'></span> Manage User</a></li>";
	 echo "<li><a href='dashboard.php?my_account' ><span class=' fa fa-user' style='color:palegreen'></span>" . $_SESSION['email'] . "</a></li>";

...
$insert_user = "insert into pillars_admin (first_name,last_name,email,username,password,phone_no ) values( '$user_firstname','$user_lastname','$user_email','$user_username','$user_password','$user_phoneno')";		

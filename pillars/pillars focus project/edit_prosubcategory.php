...
<p><a href=""> logout</a></p>
    ...
    $get_subcategory = "select * from product_subcategory where subcategory_id = $edit_subcategory";
    $run_subcategory = mysqli_query($con,$get_subcategory);
	...
	$subcat_catname= $row_subcat['category_name'];
	$subcat_description= $row_subcat['description'];
	$subcat_addedby= $row_subcat['added_by'];
...
<form class="form-horizontal" role="form" action="add_prosubcategory.php" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										  <input class="input-xlarge" type="text" id="form-field-4" placeholder="SubCategory Name" name="subcat_name" value="<?php echo $subcat_name ?>"  required="required"/>
...
<div class="form-group">
										...
										<div class="col-sm-9">
										 <select class="chosen-select form-control input-xlarge" id="form-field-select-3" placeholder="Category Name" name="category_name">
																<option value="<?php echo $subcat_catname?>">select category  </option>
							 <?php 
...
<div class="col-sm-9">
										 <textarea class="form-control limited input-xlarge" id="form-field-9" maxlength="500" placeholder="Description"  value="<?php echo $subcat_description ?>" name="description"></textarea>
											<div class="space-2"></div>
...
<div class="col-sm-9">
										  <input class="input-xlarge" type="text" id="form-field-4" placeholder="Category Name"  name="admin_id" value="<?php echo $subcat_addedby ?>" required="required"/>
											<div class="space-2"></div>
...
<div class="clearfix ">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="submit" name="subcategory_update">
...
$update_subcategory = "update product_subcategory set subcategory_name='$subcategory_name',category_name='$category_name',description='$subcategory_description',added_by='$subcategory_adminid' where subcategory_id=$subcat_id";		
 $run_subcategoryupdate = mysqli_query($con, $update_subcategory);
if($run_subcategoryupdate){

...
?> 
<div class="col-lg-9" style="min-height: 530px;">
...
$insert_user ="UPDATE users set firstname='$firstname', lastname='$lastname', phone_no='$phoneno', username='$username' where email='$emails'";
